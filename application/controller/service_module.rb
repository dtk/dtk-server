module DTK
  class Service_moduleController < AuthController
    ...
    def rest__add_user_direct_access()
      ...
      match = ServiceModule.add_user_direct_access(model_handle_with_private_group(), rsa_pub_key, username)
      rest_ok_response(:repo_manager_fingerprint => RepoManager.repo_server_ssh_rsa_fingerprint(), :repo_manager_dns => RepoManager.repo_server_dns(), :match => match)
    end

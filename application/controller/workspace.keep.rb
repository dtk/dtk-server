...
=begin
Shouldnt have to call inject and remap the values, should be done at lower level,

Would expect to be able to make call like:

obj_list = get_objects(:node,{:param1=>'foo',:param2=>2})
=end

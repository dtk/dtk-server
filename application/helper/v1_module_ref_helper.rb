  ...
  module V1ModuleRefHelper
    def ret_service_module
      ...
      if module_id
        ...
        ::DTK::CommonModule::BaseService.find_from_id?(model_handle(:service_module), module_id) ||
          raise_error_usage("No module with id '#{module_id}' exists")
      else
        ::DTK::CommonModule::BaseService.find_from_name?(model_handle(:service_module),  namespace, module_name) ||

...
#
{
  ...
  columns: {
    ...
    repo: { type: :varchar, size: 250 }, #not normalized TODO: creating problems because it has same name as model :repo
    module_name: { type: :varchar, size: 50 },
    module_namespace: { type: :varchar, size: 50 },
    parse_state: { type: :varchar, size: 25 },
    branch: { type: :varchar, size: 250, default: 'master' },
    version: { type: :varchar, size: 200, default: 'master' },

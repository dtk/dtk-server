        ...
        module Mixin
          ...
          def add_component(node_idh, aug_cmp_template, opts = {})
            ...
            Transaction do
              ...
              if service_instance = opts[:service_instance]
                existing_aug_module_branches = service_instance.aug_component_module_branches.inject({}) { |h, r| h.merge(r[:module_name] => r) }

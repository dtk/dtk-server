...
module DTK
  class Attribute < Model
    ...
    def self.common_columns
      [:id, :display_name, :group_id, :hidden, :description, :component_component_id, :value_derived, :value_asserted, :value_default, :semantic_data_type, :semantic_type, :semantic_type_summary, :data_type, :required, :dynamic, :dynamic_input, :cannot_change, :port_type_asserted, :is_port, :external_ref, :read_only, :tags]
    end

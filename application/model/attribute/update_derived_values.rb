module DTK; class Attribute
  class UpdateDerivedValues
    ...
    def self.update_attribute_values_array_append(attr_mh, array_slice_rows, _opts = {})
      ndx_ret = {}
      attr_link_updates = []
    ...
    def self.update_attribute_values_partial(attr_mh, partial_update_rows, _opts = {})

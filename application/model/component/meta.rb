...
module DTK
  module ComponentMetaClassMixin
    def up
      ...
      one_to_many :component, :attribute_link, :attribute, :port_link, :monitoring_item, :dependency, :component_order, :layout, :file_asset, :link_def, :service_add_on, :component_include_module, :task_template, :node_bindings, :service_setting, :action_def, :module_ref_lock, :assembly_instance_lock
      one_to_many_clone_omit :action_def, :service_setting, :service_add_on, :layout, :module_ref_lock, :assembly_instance_lock

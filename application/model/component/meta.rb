...
module XYZ
  module ComponentMetaClassMixin
    def up()
      ...
      one_to_many :component, :attribute_link, :attribute, :port_link, :monitoring_item, :dependency, :component_order, :layout, :file_asset, :link_def #TODO: omitted for efficiency of cloning: :service_add_on

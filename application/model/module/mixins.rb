...
module DTK
  ...
  module ModuleMixin
    ...
    def update_model_from_clone_changes?(commit_sha,diffs_summary,version,opts={})
      ...
      opts_update = Aux.hash_subset(opts,[:do_not_raise,:modification_type,:force_parse,:auto_update_module_refs,:dsl_parsed_false,:update_module_refs_from_file,:update_from_includes,:service_instance_module])

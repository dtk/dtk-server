module DTK
  class ComponentModuleRefs < Model 
    def self.set_component_module_version(service_module,component_module,component_version,service_version=nil)
      ...
      service_mb = service_module.get_module_branch_matching_version(service_version)
      ...
      if vconstraints.include_module_version?(cmp_module_name,component_version)
        return service_module.ret_clone_update_info(service_version)
      end
...
=end
      ...
      service_module.update_component_template_ids(component_module)
      
      service_module.ret_clone_update_info(service_version)
    end

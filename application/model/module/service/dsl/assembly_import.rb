...
module DTK; class ServiceModule
  class AssemblyImport
    ...
    include PortMixin
    def initialize(container_idh,module_branch,module_name,module_global_refs)
      ...
      @module_global_refs = module_global_refs
    end
      ...
      @version_proc_class.assembly_iterate(module_name,hash_content) do |assemblies_hash,node_bindings_hash|
        ...
        assemblies_hash.each do |ref,assem|
          dangling_errors.aggregate_errors! do
            ...
            @db_updates_assemblies["node"].merge!(@version_proc_class.import_nodes(@container_idh,@module_branch,ref,assem,node_bindings_hash,@module_global_refs))

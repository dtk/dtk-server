  ...
  class Project < Model
    ...
    class << self
      def up()
        ...
        one_to_many :component, :attribute_link, :node,:assoc_node_component, :node_group, :node_group_member, :network_partition, :network_gateway, :region,:assoc_region_network_partition
      end

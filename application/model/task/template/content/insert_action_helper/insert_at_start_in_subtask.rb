...
module DTK; class Task; class Template
  class Content
    class InsertActionHelper
      class InsertAtStartInSubtask < self
        def insert_action!(template_content, opts = {})
          # TODO:  DTK-2680: Aldin; content here is just cut and patse from InsertAtEnd. This needs to be changed
          #        so it looks to see if first stage is a delete subtask; if not it must create it
          #        it then will insert the action underf the subtask

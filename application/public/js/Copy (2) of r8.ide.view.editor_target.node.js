...
*/
			...
			render: function() {
//				var testTpl = '<div style="position: absolute; height: 30px; width: 80px; border: 1px solid black;"></div>';
				var testTpl = '<div id="'+_contentNodePrefix+_node.get('id')+'" class="item node basic"></div>';

...
}, '3.3.0pr3' ,{requires:['array-extras', 'escape', 'text-wordbreak']});
...
}, '3.3.0pr3' ,{requires:['highlight-base', 'text-accentfold']});


YUI.add('highlight', function(Y){}, '3.3.0pr3' ,{use:['highlight-base', 'highlight-accentfold']});

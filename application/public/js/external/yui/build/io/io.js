...
}, '3.3.0pr3' ,{requires:['event-custom-base', 'querystring-stringify-simple']});
...
}, '3.3.0pr3' ,{requires:['io-base','node-base']});
...
}, '3.3.0pr3' ,{requires:['io-base','datatype-xml']});
...
}, '3.3.0pr3' ,{requires:['io-base','queue-promote']});



YUI.add('io', function(Y){}, '3.3.0pr3' ,{use:['io-base', 'io-form', 'io-xdr', 'io-upload-iframe', 'io-queue']});

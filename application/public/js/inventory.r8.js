...
//				_events['catClick'] = R8.Utils.Y.delegate('click',this.toggleDetails,'#view-categories','.view-cat');

				R8.Utils.Y.one('#'+_item_id+'-cat').addClass('selected');
				_events['catClick'] = R8.Utils.Y.delegate('click',this.loadNewView,'#view-categories','.view-cat');
			},
			resizePage: function() {

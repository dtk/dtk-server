...
if (!R8.Cmdbar.tasks) {
	...
	R8.Cmdbar.tasks = function(def, target) {
		var _def = def,
			_id = _def['id'],
			_node = null,
			_renderList = [],
...
//				_pluginInputNode.focus();
				...
				var listTpl = '<div id="task-container" style="width:'+targetWidth+'px;">\
							</div>';
...
//TODO: revisit, temp hack to pass true to trigger REST call changes
				R8.Ctrl.call('rest/task/state_info',params,true);
			},

...
}, '3.3.0pr3' ,{requires:['attribute-base']});
...
}, '3.3.0pr3' ,{requires:['base-base', 'pluginhost']});
...
YUI.add('base', function(Y){}, '3.3.0pr3' ,{after:['attribute-complex'], use:['base-base', 'base-pluginhost', 'base-build']});

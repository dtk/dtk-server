...
}, '3.3.0pr3' ,{requires:['dom-base', 'dom-style', 'event-base']});
...
}, '3.3.0pr3' ,{requires:['selector-native']});


YUI.add('selector', function(Y){}, '3.3.0pr3' ,{use:['selector-native', 'selector-css2']});



YUI.add('dom', function(Y){}, '3.3.0pr3' ,{use:['dom-base', 'dom-style', 'dom-screen', 'selector']});

...
}, '3.3.0pr3' ,{requires:['event-custom-base']});
...
}, '3.3.0pr3' ,{requires:['node-base', 'event-custom']});
...
}, '3.3.0pr3' ,{requires:['event-synthetic']});
...
}, '3.3.0pr3' ,{requires:['event-mouseenter']});


YUI.add('event', function(Y){}, '3.3.0pr3' ,{use:['event-base', 'event-delegate', 'event-synthetic', 'event-mousewheel', 'event-mouseenter', 'event-key', 'event-focus', 'event-resize', 'event-hover']});

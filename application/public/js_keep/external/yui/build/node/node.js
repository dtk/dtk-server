...
}, '3.3.0pr3' ,{requires:['dom-base', 'selector-css2', 'event-base']});
...
}, '3.3.0pr3' ,{requires:['dom-style', 'node-base']});
...
}, '3.3.0pr3' ,{requires:['node-base', 'pluginhost']});
...
}, '3.3.0pr3' ,{requires:['node-base', 'event-delegate']});


YUI.add('node', function(Y){}, '3.3.0pr3' ,{skinnable:false, requires:['dom', 'event-base', 'event-delegate', 'pluginhost'], use:['node-base', 'node-style', 'node-screen', 'node-pluginhost', 'node-event-delegate']});

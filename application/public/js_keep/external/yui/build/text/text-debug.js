...
}, '3.3.0pr3' ,{requires:['array-extras', 'text-data-accentfold']});
...
}, '3.3.0pr3' ,{requires:['array-extras', 'text-data-wordbreak']});


YUI.add('text', function(Y){}, '3.3.0pr3' ,{use:['text-accentfold', 'text-wordbreak']});

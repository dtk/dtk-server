...
}, '3.3.0pr3' ,{requires:['attribute', 'event-focus', 'base-base', 'base-pluginhost', 'node-base', 'node-style', 'node-event-delegate', 'classnamemanager']});
...
}, '3.3.0pr3' ,{requires:['widget-base', 'node-event-delegate']});
...
YUI.add('widget', function(Y){}, '3.3.0pr3' ,{use:['widget-base', 'widget-uievents', 'widget-htmlparser', 'widget-skin']});

    ...
    class Operation
      class Get < self
        ...
        def describe_instance
          ...
          when 0
            fail "Unexpected that no instances returned for call Operation#describe_instance(#{instance_id})" 
          else
            fail "Unexpected that multiple instances returned for call Operation#describe_instance(#{instance_id})" 
          end
        end

    ...
    module Type
      class Single < Ec2::Node
        ...
        def terminate
          ...
          instance_info = (attributes.value?(:instance_id) && aws_operation(:terminate).terminate_instance)
        ...
        def dynamic_attributes(opts = {})
          instance_info =  aws_operation(:get).describe_instance
        ...
        def create_instance
          ...
          aws_operation(:create).create_instance
        end
        
        # Returns InstanceInfo object
        def describe_instance
          aws_operation(:get).describe_instance
        end
        
        # Returns InstanceInfo object
        def stop_instance
          aws_operation(:stop).stop_instance
        end
        
        # Returns InstanceInfo object
        def start_instance
          instance_info = aws_operation(:start).start_instance

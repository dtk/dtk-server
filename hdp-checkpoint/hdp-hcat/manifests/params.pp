class hdp-hcat::params() inherits hdp::params
{
  ...
  $hcat_logdirprefix = hdp_default("hadoop/hcat-env/hcat_logdirprefix","/var/log/hcat")

  $hcat_metastore_port = hdp_default("hadoop/hcat-env/hcat_metastore_port",9933)

  $hcat_piddirprefix = hdp_default("hadoop/hcat-env/hcat_piddirprefix","/usr/pids/hcat")

  ### hive-site
  $hcat_database_name = hdp_default("hadoop/hive-site/hcat_database_name")

  $hcat_metastore_port = hdp_default("hadoop/hive-site/hcat_metastore_port")

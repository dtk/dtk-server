...
module DTK
  module CommonDSL
    module ObjectLogic
      ...
      class ServiceInfoModule < ContentInputHash
        ...
        def generate_content_input!
          ...
          aaa = RepoManager.get_file_content("module_refs.yaml", implementation: @aug_component_module_branch)
        ...
        def component_defs?
          dsl_input_hash = ModuleDSL.get_dsl_file_input_hash(@aug_component_module_branch)
        ...
        def module_name
          @aug_component_module_branch.module_name
        end

...
module DTK
  class ConfigAgent
    module Type
      ...
      module Symbol
        All = [:puppet, :bash_commands, :no_op, :workflow, :dynamic, :ruby_function, :docker, :chef, :serverspec, :test, :node_module, :delete_from_database, :command_and_control_action, :cleanup]
        Default = :puppet
        All.each do |type|

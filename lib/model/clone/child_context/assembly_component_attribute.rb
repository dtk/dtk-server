    ...
    class AssemblyComponentAttribute < self
     private
      ...
      def process_attribute_overrides(new_objs_info)
        ...
        attr_override_fs = Model::FieldSet.new(:attribute_override,[:display_name,:component_ref_id,:tags,{:attribute_value => :value_asserted}])
        ...
        update_set_fs = Model::FieldSet.new(:attribute,[:value_asserted,:tags])

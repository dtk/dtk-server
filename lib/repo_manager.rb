...
module DTK
  class RepoManager
    ...
    class << self
      ...
      RepoMethods = [:move_file, :file_changed_since_specified_sha, :add_all_files_and_commit, :add_remote_files, :push_changes, :push_implementation, :add_branch, :add_branch?, :add_branch_and_push?, :merge_from_branch, :delete_local_and_remote_branch, :add_remote, :pull_changes, :ls_r, :fast_foward_merge_from_branch, :hard_reset_to_branch, :fetch_all, :rebase_from_remote, :diff, :pull_from_remote, :delete_file?, :delete_directory?, :branch_head_sha, :move_content, :file_exists?, :add_squashed_subtree, :push_squashed_subtree, :push_to_external_repo, :pull_from_external_repo, :ret_merge_relationship]

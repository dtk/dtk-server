...
system("dtk service-module install #{target_service_module} --update-none")
system("dtk component-module install #{target_component_module}")
...
system("dtk service-module install #{service_module} --update-none")

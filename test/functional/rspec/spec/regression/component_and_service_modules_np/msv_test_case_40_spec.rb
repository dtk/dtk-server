...
file_for_change_location = "./spec/regression/component_and_service_modules_np/resources/msv_test_case_40_module_refs.yaml"
...
describe "(Modules, Services and Versioning) Test Case 40: Install service module with dependency to one component and that component has dependency to another component" do
  ...
  context "Add includes to dtk.model.yaml" do
    include_context "Add includes to dtk.model.yaml", dtk_model_yaml_file_location, [component_module_name_2]
  end
  ...
  context "Remove includes from dtk.model.yaml" do
    include_context "Remove includes from dtk.model.yaml", dtk_model_yaml_file_location, [component_module_name_2]
  end

#!/usr/bin/env ruby
# Test Case 41: Install service module with dependency to one component and that component has dependency to another component which has dependency to itself
...
file_for_change_location_1 = './spec/regression/component_and_service_modules_np/resources/msv_test_case_41_1_module_refs.yaml'
file_for_change_location_2 = './spec/regression/component_and_service_modules_np/resources/msv_test_case_41_2_module_refs.yaml'
...
describe '(Modules, Services and Versioning) Test Case 41: Install service module with dependency to one component and that component has dependency to another component which has dependency to itself' do
  before(:all) do
    puts '**********************************************************************************************************************************************************************************************',''
  end
  ...
  context 'Add includes to dtk.model.yaml' do
    include_context 'Add includes to dtk.model.yaml', dtk_model_yaml_file_location_2, [component_module_name_2]
  end
  ...
  context 'Remove includes from dtk.model.yaml' do
    include_context 'Remove includes from dtk.model.yaml', dtk_model_yaml_file_location_2, [component_module_name_2]
  end

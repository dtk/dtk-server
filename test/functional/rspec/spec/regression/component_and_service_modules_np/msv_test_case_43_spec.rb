#!/usr/bin/env ruby
# Test Case 43: Install service module with dependency to one component and that component has dependency to itself
...
file_for_change_location = './spec/regression/component_and_service_modules_np/resources/msv_test_case_43_module_refs.yaml'
...
describe '(Modules, Services and Versioning) Test Case 43: Install service module with dependency to one component and that component has dependency to itself' do
  before(:all) do
    puts '****************************************************************************************************************************************************', ''
  end
  ...
  context 'Add includes to dtk.model.yaml' do
    include_context 'Add includes to dtk.model.yaml', dtk_model_yaml_file_location, [component_module_name_1]
  end
  ...
  context 'Remove includes from dtk.model.yaml' do
    include_context 'Remove includes from dtk.model.yaml', dtk_model_yaml_file_location, [component_module_name_1]
  end

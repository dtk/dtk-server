#!/usr/bin/env ruby
# Test Case 17: Install component module version, create new version, push it to remote
...
describe '(Component, service and versioning) Test Case 17: Install component module version, create new version, push it to remote' do
	before(:all) do
    	puts '*********************************************************************************************************************************', ''
  	end

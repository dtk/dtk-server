...
describe '(Component, service and versioning) Test Case 05: Install versioned component module, add it to assembly, stage assembly to service and converge the service'  do
	...
	context "Stage service function on #{assembly_name} assembly" do
  	...
  	context 'Check if component module version is in the service components list' do
  		include_context 'List components', dtk_common_new, ["#{node_name}/#{component_module_name}(#{component_module_version})"]
  	end

#!/usr/bin/env ruby
# Test Case 08: Check if deleting base component module version from remote will delete all versions
...
describe '(Component, service and versioning) Test Case 08: Check if deleting base component module version from remote will delete all versions' do
  before(:all) do
    puts '*************************************************************************************************************************************', ''
  end

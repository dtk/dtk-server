#!/usr/bin/env ruby
# Test Case 15: Install service module version, create new version, push it to remote
...
describe '(Component, service and versioning) Test Case 15: Install service module version, list assemblies' do
	before(:all) do
		puts '********************************************************************************************************************************************************', ''
	end

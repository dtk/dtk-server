#!/usr/bin/env ruby
# Test Case 15: Import service module from local filesystem, version it, publish version
...
service_module_name = 'temp15'
service_module_namespace = 'version'
imported_service_module_name = 'version:temp15'
service_module_filesystem_location = '~/dtk/service_modules/version'
version = '0.0.1'
file_name = 'csv_test_case_15_dtk.assembly.yaml'
file_to_copy_location = './spec/regression/component_and_service_modules_version/resources/csv_test_case_15_dtk.assembly.yaml'
assembly_name = "temp15"

dtk_common = Common.new('', '')

describe '(Component, service and versioning) Test Case 15: Import service module from local filesystem, version it, publish version' do
  before(:all) do
    puts '**************************************************************************************************************************', ''
  end

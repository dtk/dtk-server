#!/usr/bin/env ruby
# Test Case 20: NEG - Create version of a service module that already exists
...
describe '(Component, service and versioning) NEG - Test Case 20: Create version of a service module that already exists' do

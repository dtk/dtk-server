#!/usr/bin/env ruby
# Test Case 22: Install two component modules, add second cmp module version as dependency for first cmp module, delete both and install first cmp module
...
first_component_module_name = 'temp22_1'
first_full_component_module_name = 'version:temp22_1'
second_component_module_name = 'temp22_2'
second_full_component_module_name = 'version:temp22_2'

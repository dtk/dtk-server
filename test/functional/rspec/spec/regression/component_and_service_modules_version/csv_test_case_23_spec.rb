#!/usr/bin/env ruby
# Test Case 23: Install two component modules, add second cmp module version as dependency for first cmp module, version first cmp module and install first versioned cmp module
...
first_component_module_name = 'temp23_1'
first_full_component_module_name = 'version:temp23_1'
second_component_module_name = 'temp23_2'
second_full_component_module_name = 'version:temp23_2'
...
file_for_change_location = './spec/regression/component_and_service_modules_version/resources/csv_test_case_23_module_refs.yaml'
dtk_model_yaml_file_location = '~/dtk/component_modules/version/temp23_1/dtk.model.yaml'

dtk_common = Common.new('', '')

describe '(Component, service and versioning) Test Case 23: Install two component modules, add second cmp module version as dependency for first cmp module, version first cmp module and install first versioned cmp module' do
	before(:all) do
		puts '******************************************************************************************************************************************************************************************************************', ''
	end

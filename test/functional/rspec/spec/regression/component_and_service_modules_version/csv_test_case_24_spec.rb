#!/usr/bin/env ruby
# Test Case 23: Install service module, add cmp module version as dependency to module_refs.yaml, publish it, delete modules and install service module again and check that cmp module version is also installed
...
describe '(Component, service and versioning) Test Case 23: Install service module, add cmp module version as dependency to module_refs.yaml, publish it, delete modules and install service module again and check that cmp module version is also installed' do
	before(:all) do
		puts '************************************************************************************************************************************************************************************************************', ''
	end

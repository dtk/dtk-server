#!/usr/bin/env ruby
#Test Case 12: NEG - Ill-formed json content (type: integersss instead of integer) in dtk.model.yaml file and push-clone-changes to server
...
file_for_change_location = "./spec/dslv3_component_modules/resources/cmd_test_case_12_dtk.model.yaml"
file_for_change = "dtk.model.yaml"
dtk_common = DtkCommon.new('', '')

describe "(Component Module DSL) Test Case 12: NEG - Ill-formed json content (type: integersss instead of integer) in dtk.model.yaml file and push-clone-changes to server" do

  before(:all) do
    puts "****************************************************************************************************************************************************************"
    puts "(Component Module DSL) Test Case 12: NEG - Ill-formed json content (type: integersss instead of integer) in dtk.model.yaml file and push-clone-changes to server"
    puts "****************************************************************************************************************************************************************"
    puts ""
  end

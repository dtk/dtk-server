...
describe "(Component Module DSL) Test Case 18: NEG - dtk.model.yaml with invalid integer type attribute value" do
  ...
  context "Remove existing component in dtk.model.yaml file" do
    include_context "Replace dtk.model.yaml file with new one", local_component_module_name, file_for_change_location, file_for_change, component_module_filesystem_location, "adds invalid integer type attribute value to dtk.model.yaml"
  end

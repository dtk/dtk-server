...
file_for_change_location = "./spec/regression/dslv3_component_modules/resources/cmd_test_case_2_dtk.model.yaml"
...
describe "(Component Module DSL) Test Case 2: Rename existing component from dtk.model.yaml file, push-clone-changes to server and list components to see the effect of rename" do
  ...
  context "Rename existing component in dtk.model.yaml file" do
    include_context "Replace dtk.model.yaml file with new one", local_component_module_name, file_for_change_location, file_for_change, component_module_filesystem_location, "renames source component to source2"
  end
  ...
  context "Check if sink component exists in component module" do
    include_context "Check if component exists in component module", dtk_common, local_component_module_name, "sink"
  end

  context "Check if source2 component exists in component module" do
    include_context "Check if component exists in component module", dtk_common, local_component_module_name, "source2"
  end

  context "Check if source component exists in component module after rename" do
    include_context "NEG - Check if component exists in component module", dtk_common, local_component_module_name, "source"
  end

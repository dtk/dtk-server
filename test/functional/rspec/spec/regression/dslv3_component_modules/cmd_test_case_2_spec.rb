...
describe "(Component Module DSL) Test Case 2: Rename existing component from dtk.model.yaml file, push-clone-changes to server and list components to see the effect of rename" do
  ...
  context "Check if source2 component exists in component module" do
    include_context "Check if component exists in component module", dtk_common, component_module_name, "source2"
  end

  context "Check if source component exists in component module after rename" do
    include_context "NEG - Check if component exists in component module", dtk_common, component_module_name, "source"
  end

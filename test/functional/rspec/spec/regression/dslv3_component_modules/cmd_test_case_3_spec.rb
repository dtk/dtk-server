...
describe "(Component Module DSL) Test Case 3: Add new component from dtk.model.yaml file, push-clone-changes to server and list components to see the effect of add" do
  ...
  context "Add new component in dtk.model.yaml file" do
    include_context "Replace dtk.model.yaml file with new one", local_component_module_name, file_for_change_location, file_for_change, component_module_filesystem_location, "adds new sink2 component to dtk.model.yaml"
  end
  ...
  context "Check if sink2 component exists in component module" do
    include_context "Check if component exists in component module", dtk_common, local_component_module_name, "sink2"
  end

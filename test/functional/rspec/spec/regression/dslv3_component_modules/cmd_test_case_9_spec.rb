...
describe "(Component Module DSL) Test Case 9: Add new attribute mapping in dependencies section in dtk.model.yaml file and push-clone-changes to server" do
  ...
  before(:all) do
    puts "*********************************************************************************************************************************************"
    puts "(Component Module DSL) Test Case 9: Add new attribute mapping in dependencies section in dtk.model.yaml file and push-clone-changes to server"
    puts "*********************************************************************************************************************************************"
    puts ""
  end
  ...
  context "Add new attribute mapping in dependencies section in dtk.model.yaml file" do
    include_context "Replace dtk.model.yaml file with new one", module_name, file_for_change_location, file_for_change, module_filesystem_location, "adds port attribute mapping in dependencies section in source component in dtk.model.yaml"
  end

...
describe "(Component Module DSL) Test Case 9: Add new attribute mapping in dependencies section in dtk.model.yaml file and push-clone-changes to server" do
  ...
  context "Add new attribute mapping in dependencies section in dtk.model.yaml file" do
    include_context "Replace dtk.model.yaml file with new one", local_component_module_name, file_for_change_location, file_for_change, component_module_filesystem_location, "adds port attribute mapping in dependencies section in source component in dtk.model.yaml"
  end

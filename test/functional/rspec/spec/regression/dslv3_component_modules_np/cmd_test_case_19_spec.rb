...
file_for_change_location = "./spec/regression/dslv3_component_modules_np/resources/cmd_test_case_19_dtk.model.yaml"
...
describe "(Component Module DSL) Test Case 19: NEG - dtk.model.yaml with invalid boolean type attribute value" do
  ...
  context "Remove existing component in dtk.model.yaml file" do
    include_context "Replace dtk.model.yaml file with new one", component_module_name, file_for_change_location, file_for_change, component_module_filesystem_location, "adds invalid boolean type attribute value to dtk.model.yaml"
  end

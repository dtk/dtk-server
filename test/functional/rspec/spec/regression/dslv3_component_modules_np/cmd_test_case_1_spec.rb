...
initial_module_location = "./spec/regression/dslv3_component_modules_np/resources/cmd_test_case_1"
module_location = '/tmp/cmd_test_case_1'
module_name = 'test/cmd_test_case_1'
...
describe '(Component Module DSL) Test Case 1: Remove existing component from dtk.module.yaml file, push to server, stage assembly and check changes' do
  before(:all) do
    puts '*****************************************************************************************************************************************', ''
  end

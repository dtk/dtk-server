# Test Case 6: Add new component attribute from dtk.module.yaml file, push to server, stage assembly and check changes

require './lib/dtk_cli_spec'
require './lib/dtk_common'

initial_module_location = "./spec/regression/dslv3_component_modules_np/resources/cmd_test_case_6"
module_location = '/tmp/cmd_test_case_6'
module_name = 'test/cmd_test_case_6'
assembly_name = 'test_assembly'
service_name = 'cmd_test_case_6'
service_location = "~/dtk/"
attributes_to_check = {"node/cmd_test_case_6::component/attribute" => 'value'}
added_attributes_to_check = {"node/cmd_test_case_6::component/delta_attribute" => 'delta_value'}
original_module_name = 'cmd_test_case_6_dtk.module.yaml'
delta_module_content = 'delta_cmd_test_case_6_dtk.module.yaml'

dtk_common = Common.new("", "")

describe '(Component Module DSL) Test Case 6: Add new component attribute from dtk.module.yaml file, push to server, stage assembly and check changes' do
  before(:all) do
    puts '*******************************************************************************************************************************************', ''
  end
  ...
  context "Check attributes correct in service instance" do
    include_context "Check attributes correct in service instance", dtk_common, service_name, added_attributes_to_check
  end

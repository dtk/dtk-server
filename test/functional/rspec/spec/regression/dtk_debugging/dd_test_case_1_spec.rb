# This test script is used to test breakpoint feature on both create and delete (assembly wide)
...
delete_subtask_names_with_breakpoint = ['delete second test component']

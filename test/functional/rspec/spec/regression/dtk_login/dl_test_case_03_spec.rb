# Test Case 03: Login with new user that has DTK and correct catalog credentials but connection with repoman is not possible
require 'rubygems'
require 'rest_client'
require 'pp'
require 'json'
...
describe "Test Case 03: Login with new user that has DTK and correct catalog credentials but connection with repoman is not possible" do

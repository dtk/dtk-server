# Test Case 1: Install module (component part) from one namespace, create with another namespace, publish and delete from remote
# Pre-requisite: r8/jmeter(master) exists on repo manager
...
module_2 = 'test_ns/jmeter'
module_2_version = 'master'
module_2_location = '/tmp/test_ns/jmeter'

dtk_common = Common.new('', '')

describe "(Module operations) Test Case 1: Install module (component part) from one namespace, create with another namespace, publish and delete from remote" do
  before(:all) do
    puts '**************************************************************************************************************************************************', ''

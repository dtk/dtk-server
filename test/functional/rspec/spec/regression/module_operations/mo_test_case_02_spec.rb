# Test Case 2: Install module (service part) from one namespace, create with another namespace, publish and delete from remote
# Pre-requisite: r8/test_service_module(master) exists on repo manager

require './lib/dtk_common'
require './lib/dtk_cli_spec'

module_1 = 'r8/test_service_module'
module_1_version = 'master'
module_1_location = '/tmp/r8/test_service_module'

module_2 = 'test_ns/test_service_module'
module_2_version = 'master'
module_2_location = '/tmp/test_ns/test_service_module'

dtk_common = Common.new('', '')

describe '(Module operations) Test Case 2: Install module (service part) from one namespace, create with another namespace, publish and delete from remote' do
  before(:all) do
    puts '**************************************************************************************************************************************************', ''

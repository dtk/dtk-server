...
# Pre-requisite: test_ns/new_unit_test_5(master) exists on repo manager

require './lib/dtk_common'
require './lib/dtk_cli_spec'

module_1 = 'test_ns/new_unit_test_5'
module_1_version = 'master'
module_1_location = '/tmp/r8/new_unit_test_5'

module_2 = 'test_ns/unit_test_5'
module_2_version = 'master'
module_2_location = '/tmp/test_ns/unit_test_5'

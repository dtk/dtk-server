# Test Case 7: Negative test cases for publishing and delete from remote
# Pre-requisite: test_ns/new_unit_test_7(master) exists on repo manager

require './lib/dtk_common'
require './lib/dtk_cli_spec'

module_1 = 'test_ns/new_unit_test_7'
module_1_version = 'master'
module_1_location = '/tmp/test_ns/new_unit_test_7'

module_2 = 'test_ns/unit_test_7'
module_2_version = 'master'
module_2_location = '/tmp/test_ns/unit_test_7'
incorrect_module_2 = 'test_ns/incorrect_module'
incorrect_module_2_version = '0.0.1'
incorrect_module_2_location = '/tmp/test_ns/incorrect_module'

dtk_common = Common.new('', '')

describe "(Module operations) Test Case 7: Negative test cases for publishing and delete from remote" do
  before(:all) do
    puts '******************************************************************************************', ''
  ...
  context "Create new directory called #{module_2_location} and copy the content of #{module_1_location} in it" do
    it 'creates new directory with existing component module content in it' do
      ...
      `sed -i "s#new_unit_test_7#unit_test_7#g" #{module_2_location}/dtk.module.yaml`
  ...
  context "NEG - Publish module when incorrect module location" do
  ...
  context "NEG - Publish module again" do
    include_context "NEG - Publish module", module_2, module_2_location
  end

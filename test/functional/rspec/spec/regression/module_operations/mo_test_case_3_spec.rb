# Test Case 3: Install module (component part) from one namespace, create with another namespace, publish module version and delete from remote
# Pre-requisite: r8/new_jmeter(master) exists on repo manager

require './lib/dtk_common'
require './lib/dtk_cli_spec'

module_1 = 'r8/new_jmeter'
module_1_version = 'master'
module_1_location = '/tmp/r8/new_jmeter'

module_2 = 'test_ns/new_jmeter'
module_2_version = '0.0.1'
module_2_location = '/tmp/test_ns/new_jmeter'

dtk_common = Common.new('', '')

describe "(Module operations) Test Case 3: Install module version (component part) from one namespace, create with another namespace, publish module version and delete from remote" do
  before(:all) do
    puts '*************************************************************************************************************************************************************************', ''

#!/usr/bin/env ruby
#Test Case 10: Export module using full name #{module_name} to users default namespace and then delete it
...
describe "(Modules, Services and Versioning) Test Case 10: Export module using full name #{module_name} to users default namespace and then delete it" do

  before(:all) do
    puts "*******************************************************************************************************************************************"
    puts "(Modules, Services and Versioning) Test Case 10: Export module using full name #{module_name} to users default namespace and then delete it"
    puts "*******************************************************************************************************************************************"
    puts ""
  end

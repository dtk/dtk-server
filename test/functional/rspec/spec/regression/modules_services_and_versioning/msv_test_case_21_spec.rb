#!/usr/bin/env ruby
#Test Case 21: Ability to list components and all attributes from the specific module
...
describe "(Modules, Services and Versioning) Test Case 21: Ability to list components and all attributes from the specific module" do

  before(:all) do
    puts "***********************************************************************************************************************"
    puts "(Modules, Services and Versioning) Test Case 21: Ability to list components and all attributes from the specific module"
    puts "***********************************************************************************************************************"
    puts ""
  end

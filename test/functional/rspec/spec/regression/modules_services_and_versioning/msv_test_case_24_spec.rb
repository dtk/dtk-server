#!/usr/bin/env ruby
#Test Case 24: Import new service but all modules for that service already exist on server and locally
...
describe "(Modules, Services and Versioning) Test Case 24: Import new service but all modules for that service already exist on server and locally" do

  before(:all) do
    puts "****************************************************************************************************************************************"
    puts "(Modules, Services and Versioning) Test Case 24: Import new service but all modules for that service already exist on server and locally"
    puts "****************************************************************************************************************************************"
    puts ""
  end

  context "Import module function" do
    include_context "Import remote module", module_namespace + "/" + module_name3
  end

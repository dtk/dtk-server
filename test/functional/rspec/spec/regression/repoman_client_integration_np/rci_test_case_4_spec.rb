# Test Case 4: NEG - Make private module A (User A is not owner but belongs to User group A which is set on module, permissions: RWDP/RWD/RWD)
...
describe '(Repoman client integration) Test Case 4: NEG - Make private module A (User A is not owner but belongs to User group A which is set on module, permissions: RWDP/RWD/RWD)' do
  ...
  context "Usergroup #{user_data[:usergroup]}, user #{user_data[:another_user]} and RWDP/RWD/RWD permissions" do
  ...
  context 'NEG - Make private component module' do
    include_context 'NEG - Make private component module', dtk_common, component_module
  end

  context "Usergroup #{user_data[:usergroup]}, user #{user_data[:user]} and RWDP/RWD/RWD permissions" do
    include_context 'Check module permissions', dtk_common, user_data[:module_name], 'RWDP/RWD/RWD'
  end

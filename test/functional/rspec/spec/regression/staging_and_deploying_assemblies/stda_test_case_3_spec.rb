#!/usr/bin/env ruby
#Test Case 3: Deploy from assembly template (stage and converge), stop the running instance (nodes) and then delete assembly
...
assembly_name = 'stda_test_case_3_instance'
...
describe "(Staging And Deploying Assemblies) Test Case 3: Deploy from assembly template (stage and converge), stop the running instance (nodes) and then delete assembly" do
	...
	before(:all) do
		puts "**************************************************************************************************************************************************************"
		puts "(Staging And Deploying Assemblies) Test Case 3: Deploy from assembly template (stage and converge), stop the running instance (nodes) and then delete assembly"
		puts "**************************************************************************************************************************************************************"
		puts ""
	end

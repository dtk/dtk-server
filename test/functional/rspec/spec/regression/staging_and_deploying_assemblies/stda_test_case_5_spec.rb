...
describe "(Staging And Deploying Assemblies) Test Case 5: NEG - Renaming assembly to the name that already exist" do

	before(:all) do
		puts "******************************************************************************************************"
		puts "(Staging And Deploying Assemblies) Test Case 5: NEG - Renaming assembly to the name that already exist"
		puts "******************************************************************************************************"
		puts ""
	end

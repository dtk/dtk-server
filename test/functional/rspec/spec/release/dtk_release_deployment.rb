...
begin
	if dtk_common.check_if_assembly_exists(assembly_id)
		...
		set_attributes_array << dtk_common.set_attribute(assembly_id, 'repo_manager/dtk_repo_manager/release_tag', "v0.5.3")
		set_attributes_array << dtk_common.set_attribute(assembly_id, 'tenant/dtk_server::tenant/server_git_branch', "v0.5.3")

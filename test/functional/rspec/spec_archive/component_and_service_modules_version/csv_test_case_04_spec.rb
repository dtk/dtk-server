#!/usr/bin/env ruby
# Test Case 04: Install component module, create new version, push it to remote
...
describe '(Component, service and versioning) Test Case 04: Install component module version, create new version, push it to remote' do
	before(:all) do
    	puts '*********************************************************************************************************************************', ''
  	end

	context "Install component module from remote" do
		include_context "Import remote component module", component_module_remote_name
	end

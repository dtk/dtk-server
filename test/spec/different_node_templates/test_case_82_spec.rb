#!/usr/bin/env ruby
#Test Case 82: Stage node template and converge it (simple)
...
describe "Test Case 82: Stage node template and converge it (simple)" do

  before(:all) do
    puts "**********************************************************"
    puts "Test Case 82: Stage node template and converge it (simple)"
    puts "**********************************************************"
    puts ""
  end

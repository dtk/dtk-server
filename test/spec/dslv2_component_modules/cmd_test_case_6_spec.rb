#!/usr/bin/env ruby
#Test Case 6: Add new component attribute in dtk.model.json file, push-clone-changes to server and check if component attribute present
...
file_for_change_location = "./spec/dslv2_component_modules/resources/cmd_test_case_6_dtk.model.json"
file_for_change = "dtk.model.json"
$assembly_id = 0

dtk_common = DtkCommon.new(assembly_name, assembly_template)

describe "(Component Module DSL) Test Case 6: Add new component attribute in dtk.model.json file, push-clone-changes to server and check if component attribute present" do

  before(:all) do
    puts "*************************************************************************************************************************************************************"
    puts "(Component Module DSL) Test Case 6: Add new component attribute in dtk.model.json file, push-clone-changes to server and check if component attribute present"
    puts "*************************************************************************************************************************************************************"
    puts ""
  end
  ...
  context "Add new component attribute in dtk.model.json file" do
    include_context "Replace dtk.model.json file with new one", module_name, file_for_change_location, file_for_change, module_filesystem_location, "adds param1 attribute to source component in dtk.model.json"
  end

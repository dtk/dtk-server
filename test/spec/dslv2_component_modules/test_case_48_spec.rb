#!/usr/bin/env ruby
#Test Case 48: Remove existing component from dtk.model.json file, push-clone-changes to server and list components to see the effect of remove
...
file_for_change_location = "./lib/spec/dslv2_component_modules/resources/test_case_48_dtk.model.json"
file_for_change = "dtk.model.json"

dtk_common = DtkCommon.new("", "")

describe "Test Case 48: Remove existing component from dtk.model.json file, push-clone-changes to server and list components to see the effect of remove" do

  before(:all) do
    puts "**********************************************************************************************************************************************"
    puts "Test Case 48: Remove existing component from dtk.model.json file, push-clone-changes to server and list components to see the effect of remove"
    puts "**********************************************************************************************************************************************"
  end

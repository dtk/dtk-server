#!/usr/bin/env ruby
#Test Case 50: Add new component from dtk.model.json file, push-clone-changes to server and list components to see the effect of add
...
file_for_change_location = "./lib/spec/dslv2_component_modules/resources/test_case_50_dtk.model.json"
file_for_change = "dtk.model.json"

dtk_common = DtkCommon.new("", "")

describe "Test Case 50: Add new component from dtk.model.json file, push-clone-changes to server and list components to see the effect of add" do

  before(:all) do
    puts "***********************************************************************************************************************************"
    puts "Test Case 50: Add new component from dtk.model.json file, push-clone-changes to server and list components to see the effect of add"
    puts "***********************************************************************************************************************************"
  end

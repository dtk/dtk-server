#!/usr/bin/env ruby
#Test Case 52: Rename existing component attribute in dtk.model.json file, push-clone-changes to server and check if component attribute present
...
assembly_name = 'test_case_52_instance'
...
describe "Test Case 52: Rename existing component attribute in dtk.model.json file, push-clone-changes to server and check if component attribute present" do

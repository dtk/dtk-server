#!/usr/bin/env ruby
#Test Case 53: Add new component attribute in dtk.model.json file, push-clone-changes to server and check if component attribute present
...
assembly_name = 'test_case_53_instance'
...
file_for_change_location = "./lib/spec/dslv2_component_modules/resources/test_case_53_dtk.model.json"
file_for_change = "dtk.model.json"
$assembly_id = 0

dtk_common = DtkCommon.new(assembly_name, assembly_template)

describe "Test Case 53: Add new component attribute in dtk.model.json file, push-clone-changes to server and check if component attribute present" do

#!/usr/bin/env ruby
#Test Case 5: Rename existing component attribute in dtk.model.json file, push-clone-changes to server and check if component attribute present
...
assembly_name = 'cmd_test_case_5_instance'
...
file_for_change_location = "./spec/dslv2_component_modules/resources/cmd_test_case_5_dtk.model.json"
file_for_change = "dtk.model.json"
$assembly_id = 0

dtk_common = DtkCommon.new(assembly_name, assembly_template)

describe "(Component Module DSL) Test Case 5: Rename existing component attribute in dtk.model.json file, push-clone-changes to server and check if component attribute present" do

  before(:all) do
    puts "*********************************************************************************************************************************************************************"
    puts "(Component Module DSL) Test Case 5: Rename existing component attribute in dtk.model.json file, push-clone-changes to server and check if component attribute present"
    puts "*********************************************************************************************************************************************************************"
    puts ""
  end
  ...
  context "Rename existing component attribute in dtk.model.json file" do
    include_context "Replace dtk.model.json file with new one", module_name, file_for_change_location, file_for_change, module_filesystem_location, "renames param2 attribute from source component to test_attribute in dtk.model.json"
  end

#!/usr/bin/env ruby
#Test Case 69: Import module from git repo url
...
module_name = "ruby"
git_ssh_repo_url = "git@github.com:puppetlabs/puppetlabs-ruby.git"
module_filesystem_location = "~/dtk/component_modules"
$assembly_id = 0

dtk_common = DtkCommon.new('', '')

describe "Test Case 69: Import module from git repo url" do

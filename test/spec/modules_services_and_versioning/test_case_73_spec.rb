#!/usr/bin/env ruby
#Test Case 73: Import module from puppet forge, add its components and converge the assembly
...
assembly_name = 'test_case_73_instance'
...
describe "Test Case 73: Import module from puppet forge, add its components and converge the assembly" do

  before(:all) do
    puts "*******************************************************************************************"
    puts "Test Case 73: Import module from puppet forge, add its components and converge the assembly"
    puts "*******************************************************************************************"
  end

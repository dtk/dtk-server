#!/usr/bin/env ruby
#Test Case 85: Ability to list attributes that belong only to specific component in module
...
describe "Test Case 85: Ability to list attributes that belong only to specific component in module" do

  before(:all) do
    puts "*****************************************************************************************"
    puts "Test Case 85: Ability to list attributes that belong only to specific component in module"
    puts "*****************************************************************************************"
    puts ""
  end

#!/usr/bin/env ruby
#Test Case 89: NEG - Import new service but its referenced module exists locally but not on server
...
describe "Test Case 89: NEG - Import new service but its referenced module exists locally but not on server" do

  before(:all) do
    puts "*************************************************************************************************"
    puts "Test Case 89: NEG - Import new service but its referenced module exists locally but not on server"
    puts "*************************************************************************************************"
    puts ""
  end

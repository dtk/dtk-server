#!/usr/bin/env ruby
#Test Case 42: Add new target to existing provider, stage and converge assembly in this target and then delete target
...
assembly_name = 'test_case_42_instance'
...
describe "Test Case 42: Add new target to existing provider, stage and converge assembly in this target and then delete target" do

	before(:all) do
		puts "********************************************************************************************************************"
		puts "Test Case 42: Add new target to existing provider, stage and converge assembly in this target and then delete target"
		puts "********************************************************************************************************************"
		puts ""
  	end

#!/usr/bin/env ruby
#Test Case 43: Add new target to existing provider, stage two assemblies and check list of assemblies that belong to this target
...
assembly_name1 = 'test_case_43_instance_1'
assembly_name2 = 'test_case_43_instance_2'
...
describe "Test Case 43: Add new target to existing provider, stage two assemblies and check list of assemblies that belong to this target" do

	before(:all) do
		puts "*******************************************************************************************************************************"
		puts "Test Case 43: Add new target to existing provider, stage two assemblies and check list of assemblies that belong to this target"
		puts "*******************************************************************************************************************************"
		puts ""
  	end

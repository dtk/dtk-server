#!/usr/bin/env ruby
#Test Case 44: Add new target to existing provider, stage two assemblies and check list of nodes that belong to this target
...
assembly_name1 = 'test_case_44_instance_1'
assembly_name2 = 'test_case_44_instance_2'
...
describe "Test Case 44: Add new target to existing provider, stage two assemblies and check list of nodes that belong to this target" do

	before(:all) do
		puts "**************************************************************************************************************************"
		puts "Test Case 44: Add new target to existing provider, stage two assemblies and check list of nodes that belong to this target"
		puts "**************************************************************************************************************************"
		puts ""
  	end

#!/usr/bin/env ruby
#Test Case 72: NEG - Import module from puppet forge with incorrect puppet module name
...
describe "Test Case 72: NEG - Import module from puppet forge with incorrect puppet module name" do

  before(:all) do
    puts "*************************************************************************************"
    puts "Test Case 72: NEG - Import module from puppet forge with incorrect puppet module name"
    puts "*************************************************************************************"
  end

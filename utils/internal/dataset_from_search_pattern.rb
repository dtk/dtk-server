    ...
    class DataSetSearchPattern < Dataset
      class << self
        def create_dataset_from_search_object(search_object)
          ...
          raise SimpleSearchPattern::ErrorNotImplemented.new("processing of search pattern of type #{search_pattern.class.to_s}") unless search_pattern.kind_of?(SearchPatternSimple)

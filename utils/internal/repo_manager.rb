...
module XYZ
  class RepoManager 
    class << self
      ...
      RepoMethods = [:get_file_content,:update_file_content,:add_file,:add_all_files,:push_implementation,:add_branch,:add_branch?,:add_branch_and_push_to_origin?,:merge_from_branch,:delete_branch,:add_remote,:pull_changes,:diff,:ls_r,:fast_foward_merge_from_branch,:fetch_all,:rebase_from_remote,:diff]
